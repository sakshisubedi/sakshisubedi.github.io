...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/1uRVafuYcTMZPQjJZPqWi_htRu5rwBm6V/view?usp=sharing", // Set to empty to hide the button
  ...
  schools: [
    {
      ...
      desc: "",
      descBullets: [
        "Coursework: Principles of Computer Architecture, Recommender Systems and Web Mining, Probalistic Reasoning and Learning."
      ]
    },
    {
